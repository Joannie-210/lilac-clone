  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <nav className="px-6 md:px-10 flex w-full bg-[#FDF2F2] items-center justify-between font-sans h-20">
        <h1 className="text-xl md:text-2xl font-bold text-[#243a1f]">
          Lilac template
        </h1>
        <div className="flex items-center gap-6 md:gap-10 text-[#243a1f] font-medium">
          <p className="cursor-pointer hover:opacity-70 transition-opacity">Blog</p>
          <p className="cursor-pointer hover:opacity-70 transition-opacity">Contact</p>
        </div>
      </nav>
     ...
     <section className="bg-[#FAF7F2] py-20 px-6 md:px-12 lg:px-24">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative w-100 h-200 max-w-[500px] mx-auto lg:mx-0">
